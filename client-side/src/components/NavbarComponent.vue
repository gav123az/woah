...
<template>
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <router-link :to="{ name: 'Home'}" class="navbar-brand text-dark fw-bold fs-1 ">Kaito Ramen</router-link>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="navbar-nav ms-auto">
                    ...
                    <router-link :to="{ name: 'Profile' }" class="nav-link ms-2 me-2 fw-semibold" v-if="user.token">Profile</router-link>
